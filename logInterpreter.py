...
class LogInterpreter:
    ...
    #toDo: sdp er egentlig i headers, så legg til noe for å fikse dette
    def createJsonPacketsFromExtractedHeaders(self, preHeaders, headers, sdp): 
        json_packets = []
        for i in range(len(preHeaders)):
            ...
            messageType, sip_to, sip_from, sip_content = logInterpreter.extract_header(headers[i])
            sdp = sdp
