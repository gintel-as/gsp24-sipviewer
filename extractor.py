...
class Extractor:
    ...
    def split_header_array2(self, index): # Retrieve header with index "index" from header array
    ...
    def extract_header(self, index):
        header = self.split_header_array2(index)
        # print(header)
...
if __name__ == "__main__":
    ...
    test2 = extractor.extract_header(0)
    print(test2)
